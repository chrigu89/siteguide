...
hartzsys='120+';
alert_ausgeben('DrainPlusLiner 2.0 kann nur mit dem Harzsystem HC120+ und einer Wandstärke von 4,5mm verwendet werden!');	
}
...
if(liner_tst=="DrainPlusLiner 2.0"){
	...
	DPL_2_0_alert();
					...
					if(document.getElementById('sel').value=="Metrisch"){
